...
class Resource extends adminjs_1.BaseResource {
    ...
    async populate(baseRecords, property) {
        ...
        baseRecords.forEach((baseRecord) => {
            ...
            if (recordsHash[id]) {
                const referenceRecord = new adminjs_1.BaseRecord(recordsHash[id].toJSON(), this);
    ...
    async find(filter, { limit = 20, offset = 0, sort = {} }) {
        ...
        return sequelizeObjects.map((sequelizeObject) => new adminjs_1.BaseRecord(sequelizeObject.toJSON(), this));
    }
    async findOne(id) {
        ...
        return new adminjs_1.BaseRecord(sequelizeObject.toJSON(), this);
    }
    async findMany(ids) {
